...
import 'package:irama/app/modules/home/views/semua_catergori.dart';
    ...
    Widget iconCategori() {
      return Container(
        child: Row(
          ...
          children: [
            categoriC('Properti', 'assets/kontruksi.png'),
            categoriC('Kontuksi', 'assets/properti.png'),
            categoriC('Fiber Repair', 'assets/repair.png'),
            categoriC('Teknologi', 'assets/teknologi.png'),
            categoriC('Pernikahan', 'assets/rias.png'),
          ],
        ),
      );
    }
